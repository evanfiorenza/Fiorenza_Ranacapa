...
width=3,
    ...
    #On panel 5, add button for color panel
    conditionalPanel(condition = "input.tabselected == 5 |input.tabselected == 3", uiOutput("which_palette")),
  ...
  mainPanel(
    ...
    tabPanel("Taxonomy Barplot", value = 7,
             includeMarkdown("docs/tax-barplot-overview.md"),
             plotlyOutput("tax_bar"),
             plotlyOutput("rel_bar")),
    tabPanel("Taxonomy Heatmap", value = 8,
             plotlyOutput("tax_heat", height = "1000px", width = "1000px")),
    ...
    tabPanel("Beta Diversity stats", value = 6,
             ...
             h4("Multivariate homogeneity of groups dispersions - Global Statistical Test"),
             tableOutput("permTestAOV"),
